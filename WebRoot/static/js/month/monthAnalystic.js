...
function query(){
	...
	window.location.href = path+ "/monthAnalystic.do?year=" + selectValue;
}
...
function generateResUsedAnalysticXml(weekJson, weekSumJson) {
	...
	var xml = '<graph caption="'
			+ year + '年'
			+ '合格率趋势图" subcaption="月度统计" xAxisName="月份" PYAxisName="" SYAxisName="合格率" showNames="1" SYAxisMinValue="94" SYAxisMaxValue="97"  formatNumberScale="0" showValues="0" showAlternateHGridColor="1" color="1D8BD1" AlternateHGridColor="ff5904" divLineColor="ff5904" divLineAlpha="20" alternateHGridAlpha="5"'
