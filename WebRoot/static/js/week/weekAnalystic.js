...
function query(){
	...
	window.location.href = path+ "/weekAnalystic.do?year=" + selectValue;
}
...
function generateResUsedAnalysticXml(weekJson, weekSumJson) {
	...
	var xml = '<graph caption="'
			+ year + '年'
			+ '合格率趋势图" subcaption="周统计" xAxisName="周" yAxisMinValue="90" yAxisMaxValue="100" yAxisName="合格率" decimalPrecision="1" formatNumberScale="0" numberSuffix="%" showNames="1" showValues="0" showAlternateHGridColor="1" color="1D8BD1" AlternateHGridColor="ff5904" divLineColor="ff5904" divLineAlpha="20" alternateHGridAlpha="5"'
			...
			+ '<trendlines>'
  			...
  			+'</trendlines>'
			+ '</graph>'; 
			//F1683C 2277DD 88CC33 FF8811 F1683C FF0000 0000FF
	return xml;
}