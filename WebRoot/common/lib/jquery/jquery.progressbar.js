	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'images/progressbar/loading.png',						// boxImage : image around the progress bar
				barImage		: {
									0:	'images/progressbar/loading_red.png',
									30: 'images/progressbar/loading_yellow.png',
									70: 'images/progressbar/loading_green.png'
								},
			...
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					if (argvalue != null && this.bar != null && this.config != null) {
						...
						$bar.attr('className', "ui-progress");
