...
<%@page import="com.cgtest.biz.pojo.WeekData"%>
<%@page import="net.sf.json.JSONArray"%>
<%@page import="java.util.List"%>
<%
	//request数据转换成json数据->chart绘图使用
	List<WeekData> list = (List<WeekData>) request.getAttribute("weekDataList");
	JSONArray weekjsonData = JSONArray.fromObject(list);
	String weekJsonDataString = weekjsonData.toString();
	
	List<WeekData> sumlist = (List<WeekData>) request.getAttribute("weekSumDataList");
...
<html>
	...
	<body style="overflow: auto"><br />
		<div class="table_main" align="left">
			...
			<div align="left" style="padding-top:10px">
				<fieldset id="sourceData">
					...
					<div class="table_main" align="left">
						<display:table id="analystic" name="weekDataList"
							defaultorder="ascending" > 
							<display:column property="month" title="月份" group="1"/>
							<display:column property="weekSeq" title="周数"/>
							...
							<display:column property="qulifiedRate" title="周返修合格率"
		...
		<script type="text/javascript"
			src="<%=contextPath%>/static/js/week/weekAnalysticSecondRT.js"></script>
	</body>
</html>
