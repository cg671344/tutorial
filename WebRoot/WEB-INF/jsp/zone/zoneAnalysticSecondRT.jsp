...
<html>
	...
	<body style="overflow: auto">
		<div class="table_main" align="left">
			...
			<div align="left" style="width:100%">
				<fieldset id="resAllocationFieldSet">
					...
					<div id="zoneClsssChartContainer" align="center" style="width:100%"></div>
				</fieldset>
			</div>
			<div align="left" style="padding-top:10px">
				<fieldset id="sourceData">
					...
					<iframe id="tableFrame" scrolling="auto" frameborder="0"
						src="<%=contextPath%>/zoneAnalysticTableSecondRT.do" style="width: 100%; height:400px"></iframe>
				</fieldset>
			</div>
		</div>
		<script type="text/javascript"
		...
		<script type="text/javascript"
			src="<%=contextPath%>/static/js/zone/zoneAnalysticSecondRT.js"></script>
	</body>
</html>
