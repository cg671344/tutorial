	...
	<body>
		<div id="recordContainer" class="table_main" align="left"
			...
			<input type="button" value="删除记录"
				onclick="deleteChecked('<%=contextPath%>/listRecords.do?id=')" />
			<display:table id="listrecord" name="rs.results" export="false"
				pagesize="${rs.pagesize}" requestURI="/listRecords.do" sort="list"
		...
		<script type="text/javascript"
			src="<%=contextPath%>/static/js/listRecord/listRecords.js"></script>
		<script type="text/javascript"
