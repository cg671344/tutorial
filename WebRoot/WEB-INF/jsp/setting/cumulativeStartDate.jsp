...
<body style="overflow-x:hidden">
	<div class="table_main" >
		<div>
			<label style="font-size: 12px;">累计合格率起始时间：</label>
			<input id="cumulativeStartDate" type="text" readonly value="${cumulativeStartDate}" onClick="WdatePicker()"/>
			<img onclick="WdatePicker({el:'cumulativeStartDate'})"
					src="<%=path%>/common/lib/My97DatePicker/skin/datePicker.gif" width="12"
					height="22" style="cursor: pointer; vertical-align: middle;" />
			<input type="button"  onclick="setting()" value="修改" />
		</div>
	</div>
	...
	<script type="text/javascript" src="<%=path%>/static/js/setting/cumulativeStartDate.js"></script>
</body>
</html>
